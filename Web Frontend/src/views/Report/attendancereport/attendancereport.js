...
function ReportHome() {
  ...
  async function requestdata() {
    ...
    const AttendanceReport = await getAttendanceReport(formData)
    setData(AttendanceReport);

    // console.log(UserLogReport.titlelist);
    setDataList(AttendanceReport.content);
    setTitleList(AttendanceReport.titlelist);
    setHeaderList(AttendanceReport.headerlist);
    setCopyrightList(AttendanceReport.copyrightlist);
    setVisible(true);
  }
  useEffect(() => {
    requestdata();
