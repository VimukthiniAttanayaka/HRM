...
export const ExcelExportMultipleSheets_Reports = ({ data, title, columns, fileName, header, copyright, sheetnames }) => {

  const exportToExcel = () => {

    const workbook = xlsx.utils.book_new();

    sheetnames.forEach(items => {
      // console.log(data);
...
export default ExcelExportMultipleSheets_Reports;