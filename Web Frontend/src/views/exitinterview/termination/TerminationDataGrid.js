...
import TerminationPopup from './TerminationPopup.js';
import { getTerminationAll } from '../../../apicalls/termination/get_all_list.js';
import { getTerminationSingle } from '../../../apicalls/termination/get_termination_single.js';
...
const TerminationDataGrid = () => {
  ...
  async function loadDetails(item, action) {
    ...
    const formData = {
      ...
      MDD_TerminationID: item
    }
    const TerminationDetails = await getTerminationSingle(formData)
  ...
  async function requestdata() {
    ...
    const TerminationDetails = await getTerminationAll(formData)
    setData(TerminationDetails);
    ...
    <CCardBody>
      <CRow>
        ...
        <CCol className='d-flex justify-content-end'>
          <TerminationPopup popupStatus={popupStatus} onClose={handleClosePopup} visible={visible} onOpen={handleOpenPopup} TerminationDetails={TerminationDetails} />
        </CCol>
      </CRow>
      <CSmartTable
        cleaner
...
export default TerminationDataGrid
