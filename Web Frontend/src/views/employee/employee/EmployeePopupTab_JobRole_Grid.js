...
import { getEmployeeJobRoleAll } from '../../../apicalls/employeejobrole/get_all_list.js';
import { getEmployeeJobRoleSingle } from '../../../apicalls/employeejobrole/get_employeejobrole_single.js';
import EmployeePopupTab_JobRole_Grid_PopUp from './EmployeePopupTab_JobRole_Grid_PopUp.js';
import { getBadge } from '../../shared/gridviewconstants.js';

import { columns, headers } from '../../controllers/employeejobrole_controllers.js';
import { getLabelText } from 'src/MultipleLanguageSheets'

const EmployeePopupTab_JobRole_Grid = ({ EmployeeDetails, popupStatus, employeeId }) => {
  ...
  async function loadDetails(item, action) {
    ...
    const EmployeeJobRoleDetails = await getEmployeeJobRoleSingle(formData)
    setEmployeeJobRoleDetails(EmployeeJobRoleDetails);
    handleOpenPopup1()
  }

  const [EmployeeJobRoleDetails, setEmployeeJobRoleDetails] = useState([])
  ...
  return (
    <>
      <CTabPanel className="p-3" itemKey="jobrole">
        <CCardBody>
          <CRow>
...
export default EmployeePopupTab_JobRole_Grid
