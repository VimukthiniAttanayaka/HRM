...
const CountryPopup = ({ visible, onClose, onOpen, countryDetails }) => {
  ...
  return (
    <>
      ...
      >
        <CModalHeader>
          <CModalTitle id="TooltipsAndPopoverExample">Create New Country</CModalTitle>
        </CModalHeader>
        <CModalBody>
            ...
            <CCardBody className="p-4">
              <CForm onSubmit={handleSubmit}>
                <CInputGroup className="mb-3">
                  ...
                  </CCol>   <CFormInput placeholder="CountryID" name="CountryID" value={countryDetails.MDCTY_CountryID} onChange={handleChangeId}
                ...
                <CInputGroup className="mb-3">
                  ...
                  </CCol>    <CFormInput placeholder="Country" name="Country" value={countryDetails.MDCTY_Country} onChange={handleChangeCountry}
                  // value={addressBuildingName} onChange={handleChangeAddressBuildingName}
                  />
                </CInputGroup>
                <CInputGroup className="mb-3">
