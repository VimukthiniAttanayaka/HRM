...
const AdvanceSearchPopup = ({ visible, onClose, onOpen, UserAccessGroupDetails }) => {
  ...
  const [selectedOptionsUserName, setSelectedOptionsUserName] = useState([]);
  const [selectedOptionsAccessGroup, setSelectedOptionsAccessGroup] = useState([]);
  ...
  return (
    <>
      <CButton color="primary" onClick={onOpen}>Advance Search</CButton>
      <CModal size='lg'
        scrollable
        alignment="center"
        visible={visible}
      ...
      >
        <CModalHeader>
          <CModalTitle id="TooltipsAndPopoverExample">Advance Search</CModalTitle>
        </CModalHeader>
        <CModalBody>
            ...
            <CCardBody className="p-4">
              <CForm onSubmit={handleSubmit}>
                <CInputGroup className="mb-3">
                  ...
                  <CFormSelect value={selectedOptionsUserName} onChange={(e) => setSelectedOptionsUserName(e.target.value)}>
                ...
                <CInputGroup className="mb-3">
                  ...
                  <CFormSelect value={selectedOptionsAccessGroup} onChange={(e) => setSelectedOptionsAccessGroup(e.target.value)}>
