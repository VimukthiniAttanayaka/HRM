...
export class ExternalUserDetail {
  UE_UserID; UE_FirstName; UE_LastName; UE_EmailAddress; UE_MobileNumber; UE_PhoneNumber; UE_Remarks; UE_ActiveFrom; UE_ActiveTo;
  UE_Status; UE_Pwd; UE_PwdSalt; UE_PwdLastResetDateTime; UE_CreatedBy;
