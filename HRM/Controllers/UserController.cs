...
namespace HRM.Controllers
{
    ...
    public class userController : ControllerBase
    {
        ...
        [Route("[action]")]
        //[Authorize]
        public List<ReturnUserDataModelHead> get_t_user_single(User UserID)//ok
        {
            List<ReturnUserDataModelHead> objUserHeadList = new List<ReturnUserDataModelHead>();

            try
            {
                LogAuditData.AuditLogRequest(LogAuditData.ModuleNames.HRM_API, MethodBase.GetCurrentMethod().DeclaringType.Name, MethodBase.GetCurrentMethod().Name, UserID);

                objUserHeadList = user_BL.get_t_user_single(UserID);
                return objUserHeadList;
            }
            catch (Exception ex)
            {

                ReturnUserDataModelHead objUserHead = new ReturnUserDataModelHead
                {
                    resp = false,
                ...
                objError.WriteLog(0, "UserController", "get_t_user_single", "Stack Track: " + ex.StackTrace);
                objError.WriteLog(0, "UserController", "get_t_user_single", "Error Message: " + ex.Message);
                if (ex.InnerException != null && ex.InnerException.Message != string.Empty)
                {
                    objError.WriteLog(0, "UserController", "get_t_user_single", "Inner Exception Stack Track: " + ex.InnerException.StackTrace);
                    objError.WriteLog(0, "UserController", "get_t_user_single", "Inner Exception Message: " + ex.InnerException.Message);
                }
        ...
        [Route("[action]")]
        //[Authorize]
        public List<ReturnUserallDataModelHead> get_t_user_all(GeUserAllModel Userall)//ok
        {
            List<ReturnUserallDataModelHead> objUserHeadList = new List<ReturnUserallDataModelHead>();
            List<ReturnUserallDataModel> objUserSList = new List<ReturnUserallDataModel>();


            try
            {
                LogAuditData.AuditLogRequest(LogAuditData.ModuleNames.HRM_API, MethodBase.GetCurrentMethod().DeclaringType.Name, MethodBase.GetCurrentMethod().Name, Userall);

                objUserHeadList = user_BL.get_t_user_all(Userall);
                return objUserHeadList;
            }
            catch (Exception ex)
            {

                ReturnUserallDataModelHead objUserHead = new ReturnUserallDataModelHead
                {
                    resp = false,
                    msg = ex.Message.ToString()
                };
                ...
                objError.WriteLog(0, "UserController", "get_t_user_all", "Stack Track: " + ex.StackTrace);
                objError.WriteLog(0, "UserController", "get_t_user_all", "Error Message: " + ex.Message);
                if (ex.InnerException != null && ex.InnerException.Message != string.Empty)
                {
                    objError.WriteLog(0, "UserController", "get_t_user_all", "Inner Exception Stack Track: " + ex.InnerException.StackTrace);
                    objError.WriteLog(0, "UserController", "get_t_user_all", "Inner Exception Message: " + ex.InnerException.Message);
                }
        ...
        [Route("[action]")]
        //[Authorize]
        public List<ReturnUserall_SingleDataModelHead> get_t_user_all_unique(GeUserAllModel Userall)//ok
        {
            List<ReturnUserall_SingleDataModelHead> objUserHeadList = new List<ReturnUserall_SingleDataModelHead>();
            List<ReturnUserall_SingleDataModel> objUserSList = new List<ReturnUserall_SingleDataModel>();
            ...
            try
            {
                ...
                objUserHeadList = user_BL.get_t_user_all_unique(Userall);
                return objUserHeadList;
            }
            catch (Exception ex)
            {

                ReturnUserall_SingleDataModelHead objUserHead = new ReturnUserall_SingleDataModelHead
                {
                    resp = false,
                    msg = ex.Message.ToString()
                };
                ...
                objError.WriteLog(0, "UserController", "get_t_user_all_unique", "Stack Track: " + ex.StackTrace);
                objError.WriteLog(0, "UserController", "get_t_user_all_unique", "Error Message: " + ex.Message);
                if (ex.InnerException != null && ex.InnerException.Message != string.Empty)
                {
                    objError.WriteLog(0, "UserController", "get_t_user_all_unique", "Inner Exception Stack Track: " + ex.InnerException.StackTrace);
                    objError.WriteLog(0, "UserController", "get_t_user_all_unique", "Inner Exception Message: " + ex.InnerException.Message);
                }
            }
        ...
        [Route("[action]")]
        //[Authorize]
        public List<ReturnResponse> inactivate_t_user(InactiveUserModel item)//ok
        {
            ...
            try
            {
                ...
                objUserHeadList = user_BL.inactivate_t_user(item);
                return objUserHeadList;
            }
            catch (Exception ex)
            {
                ...
                objError.WriteLog(0, "UserController", "inactivate_t_user", "Stack Track: " + ex.StackTrace);
                objError.WriteLog(0, "UserController", "inactivate_t_user", "Error Message: " + ex.Message);
                if (ex.InnerException != null && ex.InnerException.Message != string.Empty)
                {
                    objError.WriteLog(0, "UserController", "inactivate_t_user", "Inner Exception Stack Track: " + ex.InnerException.StackTrace);
                    objError.WriteLog(0, "UserController", "inactivate_t_user", "Inner Exception Message: " + ex.InnerException.Message);
                }
                return objUserHeadList;
            }
        ...
        [Route("[action]")]
        //[Authorize]
        public List<ReturnCustomerUserAllModelHead> get_c_user_all_unique_withpccode(GetCustomerUserAllModel CUserall)//ok
        {
            List<ReturnCustomerUserAllModelHead> objCusUserHeadList = new List<ReturnCustomerUserAllModelHead>();
            ...
            try
            {
                ...
                objCusUserHeadList = user_BL.get_c_user_all_unique_withpccode(CUserall);
                return objCusUserHeadList;
            }
            catch (Exception ex)
            {
                ...
                objError.WriteLog(0, "UserController", "get_c_user_all_unique_withpccode", "Stack Track: " + ex.StackTrace);
                objError.WriteLog(0, "UserController", "get_c_user_all_unique_withpccode", "Error Message: " + ex.Message);
                if (ex.InnerException != null && ex.InnerException.Message != string.Empty)
                {
                    objError.WriteLog(0, "UserController", "get_c_user_all_unique_withpccode", "Inner Exception Stack Track: " + ex.InnerException.StackTrace);
                    objError.WriteLog(0, "UserController", "get_c_user_all_unique_withpccode", "Inner Exception Message: " + ex.InnerException.Message);
                }
        ...
        [Route("[action]")]
        //[Authorize]
        public List<ReturnResponse> add_new_t_user(UserModel item)//ok
        {
            List<ReturnResponse> objUserHeadList = new List<ReturnResponse>();
            ...
            try
            {
                ...
                objUserHeadList = user_BL.add_new_t_user(item);
                return objUserHeadList;
            }
            catch (Exception ex)
            {
                ...
                objError.WriteLog(0, "UserController", "add_new_t_user", "Stack Track: " + ex.StackTrace);
                objError.WriteLog(0, "UserController", "add_new_t_user", "Error Message: " + ex.Message);
                if (ex.InnerException != null && ex.InnerException.Message != string.Empty)
                {
                    objError.WriteLog(0, "UserController", "add_new_t_user", "Inner Exception Stack Track: " + ex.InnerException.StackTrace);
                    objError.WriteLog(0, "UserController", "add_new_t_user", "Inner Exception Message: " + ex.InnerException.Message);
                }
        ...
        [Route("[action]")]
        //[Authorize]
        public List<ReturnResponse> modify_t_user(UserModel item)//ok
        {
            List<ReturnResponse> objUserHeadList = new List<ReturnResponse>();
            ...
            try
            {
                ...
                objUserHeadList = user_BL.modify_t_user(item);
                return objUserHeadList;
            }
            catch (Exception ex)
            {
                ...
                objError.WriteLog(0, "UserController", "modify_t_user", "Stack Track: " + ex.StackTrace);
                objError.WriteLog(0, "UserController", "modify_t_user", "Error Message: " + ex.Message);
                if (ex.InnerException != null && ex.InnerException.Message != string.Empty)
                {
                    objError.WriteLog(0, "UserController", "modify_t_user", "Inner Exception Stack Track: " + ex.InnerException.StackTrace);
                    objError.WriteLog(0, "UserController", "modify_t_user", "Inner Exception Message: " + ex.InnerException.Message);
                }
        ...
        ////[Authorize]
        //[Obsolete]
        //public List<UserExcelUploadModel> loadexcelsample(UserExcelSampleModel item)
        //{
        //    List<UserExcelUploadModel> objHeadList = new List<UserExcelUploadModel>();
        //    try
        //    {
        //        LogAuditData.AuditLogRequest(LogAuditData.ModuleNames.HRM_API, MethodBase.GetCurrentMethod().DeclaringType.Name, MethodBase.GetCurrentMethod().Name, "");
        ...
        //        if (string.IsNullOrEmpty(fileNamewithPath)) { objHeadList.Add(new UserExcelUploadModel() { }); return objHeadList; }
        ...
        //        objHeadList.Add(new UserExcelUploadModel() { ExcelFileUploaded = fileContent, base64String = base64String });
        //        return objHeadList;
        //    }
        //    catch (Exception ex)
        //    {
        ...
        //        objError.WriteLog(0, "userController", "loadexcelsample", "Stack Track: " + ex.StackTrace);
        //        objError.WriteLog(0, "userController", "loadexcelsample", "Error Message: " + ex.Message);
        //        if (ex.InnerException != null && ex.InnerException.Message != string.Empty)
        //        {
        //            objError.WriteLog(0, "userController", "loadexcelsample", "Inner Exception Stack Track: " + ex.InnerException.StackTrace);
        //            objError.WriteLog(0, "userController", "loadexcelsample", "Inner Exception Message: " + ex.InnerException.Message);
        //        }
        ...
        /// <returns></returns>
        [Route("sync_c_user_kioski")]
        [HttpPost]
        public List<ReturnResponse> sync_c_user_kioski(CUser item)
        {
            try
            {
                //LogAuditData.AuditLogRequest(LogAuditData.ModuleNames.HRM_API, MethodBase.GetCurrentMethod().DeclaringType.Name, MethodBase.GetCurrentMethod().Name, model);

                return HRM_DAL.Data.User_Data.sync_c_user_kioski(item);
