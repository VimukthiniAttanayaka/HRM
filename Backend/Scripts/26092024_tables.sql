...
/****** Object:  Table [dbo].[tblUserRoleAccessGroup]    Script Date: 9/26/2024 2:22:04 AM ******/
...
/****** Object:  Table [dbo].[tblLocation]    Script Date: 9/26/2024 2:22:04 AM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[tblLocation]') AND type in (N'U'))
DROP TABLE [dbo].[tblLocation]
GO

/****** Object:  Table [dbo].[tblJobRoleDescription]    Script Date: 9/26/2024 2:22:04 AM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[tblJobRoleDescription]') AND type in (N'U'))
DROP TABLE [dbo].[tblJobRoleDescription]
GO

/****** Object:  Table [dbo].[tblJobRole]    Script Date: 9/26/2024 2:22:04 AM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[tblJobRole]') AND type in (N'U'))
DROP TABLE [dbo].[tblJobRole]
GO

/****** Object:  Table [dbo].[tblErrorLog]    Script Date: 9/26/2024 2:22:04 AM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[tblErrorLog]') AND type in (N'U'))
DROP TABLE [dbo].[tblErrorLog]
GO

/****** Object:  Table [dbo].[tblEmployee_ReportingManager]    Script Date: 9/26/2024 2:22:04 AM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[tblEmployee_ReportingManager]') AND type in (N'U'))
DROP TABLE [dbo].[tblEmployee_ReportingManager]
GO

/****** Object:  Table [dbo].[tblEmployee_JobRole]    Script Date: 9/26/2024 2:22:04 AM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[tblEmployee_JobRole]') AND type in (N'U'))
DROP TABLE [dbo].[tblEmployee_JobRole]
GO

/****** Object:  Table [dbo].[tblEmployee_EmployeeDocument]    Script Date: 9/26/2024 2:22:04 AM ******/
...
/****** Object:  Table [dbo].[tblEmployee]    Script Date: 9/26/2024 2:22:04 AM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[tblEmployee]') AND type in (N'U'))
DROP TABLE [dbo].[tblEmployee]
GO

/****** Object:  Table [dbo].[tblDepartment]    Script Date: 9/26/2024 2:22:04 AM ******/
...
/****** Object:  Table [dbo].[tblAccessGroup]    Script Date: 9/26/2024 2:22:04 AM ******/
...
/****** Object:  Table [dbo].[tbl_user_profile_map]    Script Date: 9/26/2024 2:22:04 AM ******/
...
/****** Object:  Table [dbo].[tbl_user_internal]    Script Date: 9/26/2024 2:22:04 AM ******/
...
/****** Object:  Table [dbo].[tbl_user_external]    Script Date: 9/26/2024 2:22:04 AM ******/
...
/****** Object:  Table [dbo].[tbl_system_parameter]    Script Date: 9/26/2024 2:22:04 AM ******/
...
/****** Object:  Table [dbo].[tbl_holidaycalender]    Script Date: 9/26/2024 2:22:04 AM ******/
...
/****** Object:  Table [dbo].[tbl_excel_upload_data_tracer]    Script Date: 9/26/2024 2:22:04 AM ******/
...
/****** Object:  Table [dbo].[tbl_country]    Script Date: 9/26/2024 2:22:04 AM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[tbl_country]') AND type in (N'U'))
DROP TABLE [dbo].[tbl_country]
GO

/****** Object:  Table [dbo].[tbl_AuditLog_ActionMap]    Script Date: 9/26/2024 2:22:04 AM ******/
...
/****** Object:  Table [dbo].[tbl_auditlog]    Script Date: 9/26/2024 2:22:04 AM ******/
