...
namespace HRM.Controllers
{
    ...
    public class PerformanceAppriasalQuestionsController : ControllerBase
    {
        ...
        [Route("[action]")]
        //[Authorize]
        public List<ReturnResponse> add_new_PerformanceAppriasalQuestions(PerformanceAppriasalQuestionsModel item)//ok
        {
        ...
        [Route("[action]")]
        //[Authorize]
        public List<ReturnResponse> modify_PerformanceAppriasalQuestions(PerformanceAppriasalQuestionsModel item)//ok
        {
            List<ReturnResponse> objCustHeadList = new List<ReturnResponse>();
