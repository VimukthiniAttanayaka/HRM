...
namespace HRM.Controllers
{
    ...
    public class UserRoleAccessGroupController : ControllerBase
    {
        ...
        [Route("[action]")]
        //[Authorize]
        public List<ReturnResponse> add_new_UserRoleAccessGroup(UserRoleAccessGroupModel item)//ok
        {
        ...
        [Route("[action]")]
        //[Authorize]
        public List<ReturnResponse> modify_UserRoleAccessGroup(UserRoleAccessGroupModel item)//ok
        {
            List<ReturnResponse> objCustHeadList = new List<ReturnResponse>();
