...
namespace HRM.Controllers
{
    ...
    public class PerformanceAppriasalAnswersController : ControllerBase
    {
        ...
        [Route("[action]")]
        //[Authorize]
        public List<ReturnResponse> add_new_PerformanceAppriasalAnswers(PerformanceAppriasalAnswersModel item)//ok
        {
        ...
        [Route("[action]")]
        //[Authorize]
        public List<ReturnResponse> modify_PerformanceAppriasalAnswers(PerformanceAppriasalAnswersModel item)//ok
        {
            List<ReturnResponse> objCustHeadList = new List<ReturnResponse>();
